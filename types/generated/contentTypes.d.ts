...
export interface ApiCatalogCatalog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cover_img: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCompanyStatCompanyStat extends Struct.SingleTypeSchema {
  ...
  attributes: {
    company_stats: Schema.Attribute.Component<
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hours: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Sun \u2013 Fri, 9am \u2013 6pm NPT'>;
    isHQ: Schema.Attribute.Boolean & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::office.office'
...
export interface ApiServiceProcessStepServiceProcessStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'service_process_steps';
  info: {
    displayName: 'Service Process Step';
    pluralName: 'service-process-steps';
    singularName: 'service-process-step';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-process-step.service-process-step'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    detail_list: Schema.Attribute.Component<
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    role: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Architect'>;
...
export interface ApiWhyUsReasonWhyUsReason extends Struct.CollectionTypeSchema {
  collectionName: 'why_us_reasons';
  info: {
    displayName: 'Why Us Reason';
    pluralName: 'why-us-reasons';
    singularName: 'why-us-reason';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::why-us-reason.why-us-reason'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer &
      Schema.Attribute.Required &
